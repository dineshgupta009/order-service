...
import com.microservice.Payload.Request.PaymentRequest;
import com.microservice.Payload.Response.OrderResponse;
import com.microservice.Payload.Response.PaymentResponse;
import com.microservice.Payload.Response.ProductResponse;
...
public class OrderServiceImpl implements OrderService{
    ...
    public OrderResponse getOrderDetails(long id) {
        ...
        log.info("OrderServiceImpl | getOrderDetails | Get order details for Order Id : {}", id);

        Order order
                = orderRepository.findById(id)
                .orElseThrow(() -> new OrderServiceCustomException("Order not found for the order Id:" + id,
                        "NOT_FOUND",
                        404));
        ...
        ProductResponse productResponse
                ...
                "http://localhost:6061/product/" + order.getProductId(),
        ...
        PaymentResponse paymentResponse
                = restTemplate.getForObject(
                "http://localhost:6063/payment/order/" + order.getId(),
